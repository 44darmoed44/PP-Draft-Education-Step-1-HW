...
namespace Scripts.Effects
{
    public class InfiniteBackground : MonoBehaviour
    {
        ...
        private Vector3 _boundToTransformDelta;
        ...
        private void Start()
        {
            ...
            _boundToTransformDelta = transform.position - _allBounds.center;
        ...
        private void LateUpdate()
        {
            ...
            _allBounds.center = transform.position - _boundToTransformDelta;
